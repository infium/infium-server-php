...
$years = dbPrepareExecute($pdo, 'SELECT TaxGroup, Description FROM GeneralLedgerTaxGroupCustomerOrVendor WHERE Description LIKE ? ORDER BY Id ASC', array('%'.$input['SearchQuery'].'%'));
